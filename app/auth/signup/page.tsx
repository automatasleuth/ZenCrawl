      ...
      <div className="relative flex flex-1 flex-col items-center justify-center px-4 py-12">
        ...
        <div className="relative z-10 w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-zinc-400">Start building with structured web data</p>
          </div>
          ...
          <div className="space-y-4 rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 backdrop-blur-sm">
            <h3 className="flex items-center font-medium text-white">
              <span className="mr-2 flex h-5 w-5 items-center justify-center rounded-full bg-purple-600">
                <Check className="h-3 w-3 text-white" />
              </span>
              ZenCrawl Free Plan includes:
            </h3>
            <ul className="space-y-2 text-sm text-zinc-400">
              <li className="flex items-start">
                <Check className="mr-2 h-4 w-4 text-purple-400" />
                <span>100 credits per month (approx. 100 pages)</span>
              </li>
              <li className="flex items-start">
                <Check className="mr-2 h-4 w-4 text-purple-400" />
                <span>Basic extraction capabilities</span>
              </li>
              <li className="flex items-start">
                <Check className="mr-2 h-4 w-4 text-purple-400" />
                <span>24-hour extraction history</span>
              </li>
              <li className="flex items-start">
                <Check className="mr-2 h-4 w-4 text-purple-400" />
                <span>Access to the ZenCrawl Playground</span>
              </li>
            </ul>
          </div>
        </div>
